...
if(isset($_POST["submit"])){ 
 ...
 $ruta = $uploadPath.$fileName;
// Mostrar el estado de la imagen 
echo $statusMsg; 

 $queryAccesorio="INSERT INTO accesorios(id_accesorio,nombre_accesorio,descripcion,ruta_imagen)
VALUES(NULL, '$nombre_accesorio', '$descripcion',' $ruta')";
    echo mysqli_query($conexion,$queryAccesorio)
